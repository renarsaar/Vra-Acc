...
class HotelList extends React.Component {
  ...
  // Filter content based by hotel type
  renderFilteredList = (term) => {
    const hotelList = this.props.Hotels;
    const filteredArray = hotelList.filter((hotel) =>
    ...
    if (filteredArray.length === 0) {
      return (
        <div className="search-nomatch">
          <h1>Sorry &#58;&#40;</h1>
          <p>No matches for <code>{term}</code></p>
    ...
    return this.renderList(filteredArray);
  };
